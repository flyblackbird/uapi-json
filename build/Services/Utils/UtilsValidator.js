...
Validator.prototype.currencies = function () {
  if (Object.prototype.toString.call(this.params.currencies) !== '[object Array]') {
    throw new _UtilsErrors.UtilsValidationError.CurrenciesMissing(this.params);
  }
...
module.exports = {
  CURRENCY_CONVERSION: function CURRENCY_CONVERSION(params) {
    return new Validator(params).currencies().end();
  }
};